            ...
            <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post"
                ...
                <div class="form_content clearfix">
                    ...
                    <div class="form-group">
                        <label for="email_create"></label>
                        <input placeholder="{l s='Email address'}" type="text"
                               class="is_required validate account_input form-control" data-validate="isEmail"
                    ...
                    <div class="submit">
                        ...
                        <button class="btn btn-default button text-right" type="submit" id="SubmitCreate"
                                name="SubmitCreate">
							<span>
            ...
            <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post"
                ...
                <div class="form_content clearfix">
                    <div class="form-group">
                        ...
                        <input placeholder="{l s='Email address'}"
                               class="is_required validate account_input form-control" data-validate="isEmail"
                    ...
                    <div class="form-group">
                        ...
                        <input placeholder="{l s='Password'}" class="is_required validate account_input form-control"
                               type="password" data-validate="isPasswd" id="passwd" name="passwd"
                               value="{if isset($smarty.post.passwd)}{$smarty.post.passwd|stripslashes}{/if}"/>
                    </div>
                    <div class="text-right lost_text">

                        <p class="submit">
                            {if isset($back)}<input type="hidden" class="hidden" name="back"
                                                    value="{$back|escape:'html':'UTF-8'}" />{/if}
                            <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default">
							<span>
                ...
                <div id="opc_account_form" style="display: block; ">
                    ...
                    {foreach from=$dlv_all_fields item=field_name}
                        {if $field_name eq "company"}
                            ...
                            <div class="form-group open_houre_input">
                                <label for="open_houre">{l s='Horaire d\'ouverture'}{if in_array($field_name, $required_fields)}
                                        <sup>*</sup>
                                    {/if}</label>
                                <input type="text" class="form-control" id="open_houre" name="open_houre"
                                       value="{if isset($smarty.post.open_houre)}{$smarty.post.open_houre}{/if}"/>
                            </div>
                        ...
                        {elseif $field_name eq "postcode"}
                            ...
                            <div class="required postcode form-group">
                                ...
                                <input type="text" class="form-control" maxlength="4" name="postcode" id="postcode"
                        ...
                        {foreach from=$inv_all_fields item=field_name}
                            ...
                            {elseif $field_name eq "postcode"}
                                ...
                                <div class="required postcode_invoice form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="4" name="postcode_invoice"
                                           id="postcode_invoice"
...
{else}
    ...
    <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post"
        ...
        <div class="account_creation">
            <!-- <div class="row">
				<div class="col-md-12"><h3 class="page-subheading">{l s='Your personal information'}</h3></div>
			</div> -->
            <div class="clearfix row" id="title-gender">
                <div class="col-md-12"><label class="title-gender">{l s='Title'}</label>
            ...
            <div class="row">
                <div class="required form-group col-md-6">
                    <!-- <label for="customer_firstname"> <sup>*</sup></label> -->
                    <input placeholder="{l s='First name'}" onkeyup="$('#firstname').val(this.value);" type="text"
                           class="is_required validate form-control" data-validate="isName" id="customer_firstname"
                           name="customer_firstname"
                           value="{if isset($smarty.post.customer_firstname)}{$smarty.post.customer_firstname}{/if}"/>
                </div>
                <div class="required form-group  col-md-6">
                    <!-- <label for="customer_lastname">{l s='Last name'} <sup>*</sup></label> -->
                    <input placeholder="{l s='Last name'}" onkeyup="$('#lastname').val(this.value);" type="text"
                           class="is_required validate form-control" data-validate="isName" id="customer_lastname"
            ...
            <div class="row">
                <div class="required form-group col-md-6">
                    ...
                    <input placeholder="{l s='Email'} " type="text" class="is_required validate form-control"
                           data-validate="isEmail" id="email" name="email"
                           value="{if isset($smarty.post.email)}{$smarty.post.email}{/if}"/>
                </div>
                <div class="required password form-group col-md-6">
                    <!-- <label for="passwd">{l s='Password'} <sup>*</sup></label> -->
                    <input placeholder="{l s='Password'}" type="password" class="is_required validate form-control"
                           data-validate="isPasswd" name="passwd" id="passwd"/>
                    <!-- <span class="form_info">{l s='(Five characters minimum)'}</span> -->
                </div>
            </div>
            <div class="row" id="date_birth">
                <div class="form-group">
        ...
        {if $b2b_enable}
            <div class="account_creation">
                ...
                <p class="form-group open_houre_input">
                    <label for="open_houre">{l s='Horaire d\'ouverture'}</label>
                    <input type="text" class="form-control" id="open_houre" name="open_houre"
                           value="{if isset($smarty.post.open_houre)}{$smarty.post.open_houre}{/if}"/>
                </p>
                <p class="form-group">
        ...
        {if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
            ...
            <div class="account_creation row" id="account_adress">
                ...
                {foreach from=$dlv_all_fields item=field_name}
                    {if $field_name eq "company"}
                        {if !$b2b_enable}
                            <p class="form-group col-md-6">
                                ...
                                <input placeholder="{l s='Company'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}"
                                       type="text" class="form-control" id="company" name="company"
                                       value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}"/>
                            </p>
                            <p class="form-group col-md-6 open_houre_input">
                                <input placeholder="{l s='Horaire d\'ouverture'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}"
                                       type="text" class="form-control" id="open_houre" name="open_houre"
                                       value="{if isset($smarty.post.open_houre)}{$smarty.post.open_houre}{/if}"/>
                            </p>
                        {/if}
                    {elseif $field_name eq "vat_number"}
                        <div id="vat_number" class=" col-md-6" style="display:none;">
                            <p class="form-group">
                                <!-- <label for="vat_number">{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label> -->
                                <input placeholder="{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}"
                                       type="text" class="form-control" name="vat_number"
                                       value="{if isset($smarty.post.vat_number)}{$smarty.post.vat_number}{/if}"/>
                            </p>
                        </div>
                    {elseif $field_name eq "firstname"}
                        <p class="required form-group col-md-6">
                            <!-- <label for="firstname">{l s='First name'} <sup>*</sup></label> -->
                            <input placeholder="{l s='First name'}*" type="text" class="form-control" id="firstname"
                                   name="firstname"
                                   value="{if isset($smarty.post.firstname)}{$smarty.post.firstname}{/if}"/>
                        </p>
                    {elseif $field_name eq "lastname"}
                        <p class="required form-group col-md-6">
                            <!-- <label for="lastname">{l s='Last name'} <sup>*</sup></label> -->
                            <input placeholder="{l s='Last name'}*" type="text" class="form-control" id="lastname"
                                   name="lastname"
                                   value="{if isset($smarty.post.lastname)}{$smarty.post.lastname}{/if}"/>
                        </p>
                    {elseif $field_name eq "address1"}
                        <p class="required form-group col-md-6">
                            <!-- label for="address1">{l s='Address'} <sup>*</sup></label>  -->
                            <input placeholder="{l s='Address'}*" type="text" class="form-control" name="address1"
                                   id="address1" value="{if isset($smarty.post.address1)}{$smarty.post.address1}{/if}"/>
                            <!-- <span class="inline-infos">{l s='SP.O. Box, Company name, etctreet address, P.O. Box, Company name, etc.'}</span> -->
                    ...
                    {elseif $field_name eq "address2"}
                        <p class="form-group col-md-6">
                            ...
                            <input placeholder="{l s='Address (Line 2)'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}"
                    ...
                    {elseif $field_name eq "postcode"}
                        {assign var='postCodeExist' value=true}
                        <p class="required postcode form-group col-md-6">
                            <!-- <label for="postcode">{l s='Zip/Postal Code'} <sup>*</sup></label> -->
                            <input placeholder="{l s='Zip/Postal Code'}*" type="text" class="form-control" maxlength="4"
                    ...
                    {elseif $field_name eq "city"}
                        <p class="required form-group col-md-6">
                            <!-- <label for="city">{l s='City'} <sup>*</sup></label> -->
                            <input placeholder="{l s='City'}" type="text" class="form-control" name="city" id="city"
                                   value="{if isset($smarty.post.city)}{$smarty.post.city}{/if}"/>
                        </p>
                        <!-- if customer hasn't update his layout address, country has to be verified but it's deprecated -->
                    {elseif $field_name eq "Country:name" || $field_name eq "country"}
                        <p class="required select form-group col-md-6">
                            <!-- <label for="id_country">{l s='Country'} <sup>*</sup></label> -->
                            <select name="id_country" id="id_country" class="form-control">
                    ...
                    {elseif $field_name eq "State:name" || $field_name eq 'state'}
                        {assign var='stateExist' value=true}
                        <p class="id_state select form-group">
                            <label for="id_state">{l s='State'} <sup>*</sup></label>
                            <select name="id_state" id="id_state" class="form-control">
                                <option value="">-</option>
                            </select>
                ...
                {if !$stateExist}
                    <p class="required id_state form-group unvisible col-md-6">
                ...
                <p class="form-group col-md-6 is_customer_param">
                    ...
                    <span class="col-md-3 span-other">
					                                       		<label for="other"
                                                                       class="label-other">{l s='Livraison à l\'étage'}
                                                                    :</label>
					                                       </span>
...
{else}
                ...
                <hr class="clear">
                {if isset($one_phone_at_least) && $one_phone_at_least}
                    <p class="inline-infos clear text-center">{l s='You must register at least one phone number.'}</p>
                {/if}
                <p class="form-group col-md-6">
                    <!-- <label for="phone">{l s='Home phone'}</label> -->
                    <input placeholder="{l s='Home phone'}" type="text" class="form-control" name="phone" id="phone"
                           value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}"/>
                </p>
                <p class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group col-md-6">
                    <!-- <label for="phone_mobile">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label> -->
                    <input placeholder="{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least}*{/if}"
                           type="text" class="form-control" name="phone_mobile" id="phone_mobile"
                           value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}"/>
                    <small style="color:red">{l s='exemple de format du numéro 0041791234567, ou 0791234567'}</small>
                </p>
                <p class="form-group col-md-6"></p>
                <p class="checkbox form-group col-md-6">
                ...
                <hr class="clear">
                <p class="required form-group col-md-6" id="address_alias">
                    <!-- <label for="alias">{l s='Assign an address alias for future reference.'} <sup>*</sup></label> -->
                    <input placeholder="{l s='Assign an address alias for future reference.'}*" type="text"
                           class="form-control" name="alias" id="alias"
                           value="{if isset($smarty.post.alias)}{$smarty.post.alias}{/if}"/>
                    <small style="color:red" class="inline-infos clear text-address">
                        {l s='Attribuer un alias d\'adresse pour référence future. *'} {l s='ex: Mon adresse'}
                    </small>
                </p>
                <div class="submit clearfix text-right">
                    <input type="hidden" name="email_create" value="1"/>
                    <input type="hidden" name="is_new_customer" value="1"/>
                    {if isset($back)}<input type="hidden" class="hidden" name="back"
                                            value="{$back|escape:'html':'UTF-8'}" />{/if}
                    <p class="oblig"><span><sup>*</sup>{l s='Required field'}</span></p>
                    <button type="submit" name="submitAccount" id="submitAccount" class="btn btn-default button">
    ...
    <script type="text/javascript">
        $(function ($) {
            if (!$('#title-gender input:radio:checked').length) {
                var two = $('#title-gender input:radio:eq(0)').attr('checked', true);
                $.uniform.update(two);
            }
        })
    </script>
