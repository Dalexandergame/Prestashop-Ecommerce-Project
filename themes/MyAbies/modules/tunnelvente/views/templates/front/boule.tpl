<form action="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/pot" id="form_boule" method="post">
    ...
    <div class="list_boule">
        {foreach from=$result item=boule}
            <span class="boule boule_{$boule.id_product_attribute}">
                ...
                {/if}
                {$boule.name}
                {*                <img src="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}img/co/{$boule.id_attribute}.jpg"/>*}
            </span>            
        {/foreach}    
    </div>
    <ul>
        ...
        <li data-id="0">
            ...
            <img class="eco_img" style="display: none;"
                 src="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/views/img/bg-default-white.png"/>
        </li>
    </ul>
...
<script type="text/javascript">
    ...
    var baseurl_tunnelvente = "{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/sapin?back=1";
    {else}
    var baseurl_tunnelvente = "{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/recyclage?back=1";
    {/if}
</script>     
{literal}
<script type="text/javascript">
