<form action="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/accesoire" id="form_autresapin"
      method="post">
    <h4>{l s="Nouveau sapin" mod='tunnelvente'}</h4> 
    <ul>
        <li data-id="0"
            data-src="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}modules/tunnelvente/images/transparent.png">
        ...
        <li data-id="1"
            data-src="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}modules/tunnelvente/images/eco_new.png">
