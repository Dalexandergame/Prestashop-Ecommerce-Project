...
<ul class="footer_links clearfix">
    ...
    <li><a class="btn btn-default button button-small" href="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}"
           title="{l s='Home' mod='referralprogram'}"><span><i
                        class="icon-chevron-left"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
