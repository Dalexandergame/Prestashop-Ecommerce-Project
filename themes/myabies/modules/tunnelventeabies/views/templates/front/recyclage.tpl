<form action="{$urls.base_url}module/tunnelventeabies/boule" id="form_recyclage"
      method="post">
    <h4>{l s="Choisissez le type de recyclage" mod='tunnelventeabies'}</h4>
    <ul>
        ...
        <li data-id="0">
            ...
            <label for="recyclage_0">{l s="Je m'occupe de le recycler moi même" mod='tunnelventeabies'}</label>
        </li>
    </ul>
    ...
    <div class="description">
        ...
        <div class="description_0" style="display: none">
            {l s="Texte Je m'occupe de le recycler moi même" mod='tunnelventeabies'}
        </div>
    </div>
...
<script type="text/javascript">
    {*var baseurl_tunnelvente = "{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelventeabies/taille?back=2";*}
    var baseurl_tunnelvente = "{$urls.base_url}module/tunnelventeabies/{if $isSapinSwiss}pied{else}taille{/if}?back=1";
