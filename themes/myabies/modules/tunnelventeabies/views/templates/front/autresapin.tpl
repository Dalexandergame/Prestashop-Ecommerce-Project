<form action="{$urls.base_url}module/tunnelventeabies/accesoire" id="form_autresapin" method="post">
    <h4>{l s="Nouveau sapin" mod='tunnelventeabies'}</h4>
    <ul>
         <li data-id="0" data-src="{$urls.base_url}modules/tunnelvente/images/resume.png">
            ...
            <label for="autresapin_0">{l s="Non merci je souhaite confirmer et payer" mod='tunnelventeabies'}</label>
        </li>
        <li data-id="1" data-src="{$urls.base_url}modules/tunnelvente/images/eco_new.png" >
            ...
            <label for="autresapin_1">{l s="Je souhaite commander un autre sapin" mod='tunnelventeabies'}</label>
        </li>
        <li data-id="2" data-src="{$urls.base_url}modules/tunnelvente/images/icon_little.png">
            ...
            <label for="autresapin_2">{l s="Je souhaite commander un little sapin" mod='tunnelventeabies'}</label>
        </li>
    </ul>
    ...
    <div class="icon-tunnel">
        ...
        {*<h2>{l s="Nouveau sapin" mod='tunnelventeabies'}</h2>*}
    </div> 
...
<script type="text/javascript">
    {if $little}
        var baseurl_tunnelvente = "{$urls.base_url}module/tunnelventeabies/little";
    {else}
        var baseurl_tunnelvente = "{$urls.base_url}module/tunnelventeabies/pot";
    {/if}
</script> 
{literal}
<script type="text/javascript">
