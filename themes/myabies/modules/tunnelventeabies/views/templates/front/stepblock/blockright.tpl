<div class="col-md-6 thirdCol" data-currency="{$currency->sign}">
    <div class="container_images ">
        ...
        <div class="container_type hidden ">
            <div class="left_Type">
                <div class="transporteur">
                    <img src="{$urls.base_url}themes/ecosapin-v2/img/partenaire-fribourg.jpg"/>
                </div>
        ...
        <div class="container_taille_pot hidden ">
            <img src="{$urls.base_url}themes/ecosapin-v2/img/en-pot1.png"/>
        </div>
        ...
        <div class="container_recyclage hidden">
            ...
            <div class="image_right">
                <!--<img class="img_sapin" style="display: none;" />-->
                <img src="{$urls.base_url}themes/ecosapin-v2/img/ecosapin-nordman.png"/>
            </div>
        </div>
