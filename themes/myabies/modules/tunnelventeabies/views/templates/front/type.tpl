<form action="{$urls.base_url}module/tunnelventeabies/taille" id="form_type" method="post">
    <h4>{l s="Choisissez le type de sapin" mod='tunnelventeabies'}</h4>
    <ul>
        {foreach from=$types item=type}
            ...
            {foreachelse}
            <li class="not-taille">
                <span>{l s="Désolé nous sommes en rupture de stock, revenez plus tard" mod='tunnelventeabies'}</span>
            </li>
        {/foreach}
    </ul>
    {if count($types) }
        <div class="icon-tunnel">
            ...
            {*<h2>{l s="Choisissez le type de votre sapin" mod='tunnelventeabies'}</h2>*}
        </div>
        <div class="clear"></div>
