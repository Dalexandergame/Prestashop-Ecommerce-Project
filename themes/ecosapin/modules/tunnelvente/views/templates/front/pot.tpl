...
<form action="{$urls.base_url}module/tunnelvente/autresapin" id="form_pot" method="post">
    ...
    <div class="list_pot">
        ...
        {foreachelse}
            <span class="not-pot">
                ...
                <img style="display: none;" src="{$urls.base_url}modules/tunnelvente/images/pot/default-pot.png"  />
            </span>
        {/foreach}
        {if count($result) }
