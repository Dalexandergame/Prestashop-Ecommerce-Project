...
<div class="panel">
	<fieldset>
		<legend><img src="../img/admin/delivery.gif" /> {l s='Date de livraison & Retour ' mod='planningdeliverybycarrier'}</legend>
		...
		<form action="" id="form_update_planningdelivery" method="post" style="margin-top:10px;">
			<p id="lab_date_delivery">
				...
				{l s='Nouvelle date de retour' mod='planningdeliverybycarrier'} :
                                <input type="text" name="date_retour" id="date_retour" style="width:200px" value="{dateFormat date=$date_retour}"/>
