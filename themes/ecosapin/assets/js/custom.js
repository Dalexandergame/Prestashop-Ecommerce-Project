...
$(document).ready(function(){
    ...
    //
    // var html = "";
    // html += "<h1 id='little_decoration' style='font-size: 18px;'>D̩coration: " + decoration + "</h1>";
    ...
    //     var decoration = $('#ap5-pack-product-6 .ap5-pack-product-image a').attr('title');
    //     var html = "<h1 id='little_decoration' style='font-size: 18px;'>D̩coration: " + decoration + "</h1>";
