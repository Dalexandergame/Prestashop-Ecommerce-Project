...
{else}
    <form action="{$link->getModuleLink('bankwire', 'validation', [], true)|escape:'html':'UTF-8'}" method="post" class="pay-recap">
        <div class="box cheque-box col-md-8">
            ...
            <p>
                ...
                <span id="amount" class="price">{displayPrice price=$total} {if $use_taxes == 1}
            ...
            <p>
                ...
                {else}
                    {l s='We allow the following currency to be sent via bank wire:' mod='bankwire'}&nbsp;<b>{$currencies.0.iso_code}</b>
            ...
            <div class="cart_navigation clearfix" id="cart_navigation">
                <button class="btn btn-default btn-address-modify" type="submit">
                    <span>{l s='I confirm my order' mod='bankwire'}<!-- <i class="icon-chevron-right right"></i> --></span>
                </button>
                <a class="btn btn-default btn-address-delete" href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}">
