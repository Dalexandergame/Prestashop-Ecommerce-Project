...
{l s='Merci pour votre commande, vous allez recevoir dans 5min votre bulletin de versement  par mail'  mod='cheque'}<br />{l s='Vous pouvez aussi sans attendre, accéder à votre facture dans “ HISTORIQUE DE VOS COMMANDES”'  mod='cheque'}
</p>
