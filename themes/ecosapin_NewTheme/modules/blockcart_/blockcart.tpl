...
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">0.00 CHF{*{l s='(empty)' mod='blockcart'}*}</span>
		...
		{if !$PS_CATALOG_MODE}
			<div class="cart_block block exclusive">
				<div class="block_content">
					...
					<strong class="titre-cart">{l s='Votre panier' mod='blockcart'}</strong>
								...
								{foreach from=$products item='product' name='myLoop'}
									...
									<dt data-id="cart_block_product_{$product.id_product|intval}_{if $product.id_product_attribute}{$product.id_product_attribute|intval}{else}0{/if}_{if $product.id_address_delivery}{$product.id_address_delivery|intval}{else}0{/if}" class="{if $smarty.foreach.myLoop.first}first_item{elseif $smarty.foreach.myLoop.last}last_item{else}item{/if}">
										...
										<span class="remove_link">
											{if !isset($customizedDatas.$productId.$productAttributeId) && (!isset($product.is_gift) || !$product.is_gift) && $product.id_product != 51}
...
{if !$PS_CATALOG_MODE && $active_overlay == 1}
	<div id="layer_cart">
		<div class="clearfix">
		<div class="wrappTop">
			<div class="col-md-12 col-xs-12 text-center"><h2>
			...
			<div class="layer_cart_product col-xs-12 col-md-6">
				...
				<div class="layer_cart_product_info">
					...
					<span id="layer_cart_product_attributes hide"></span>
					...
					<div>
						<strong class="dark layer_cart_product_quantity">{l s='Quantity' mod='blockcart'} :</strong>
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				{/if}
				<div class="layer_cart_row">
					<strong class="ajax_block_cart_total_dark">
		...
		<div class="button-container col-md-12 text-right">
					<span class="continue btn btn-default  btn-add" title="{l s='Continue shopping' mod='blockcart'}">
						<span>
							<!-- <i class="icon-chevron-left left"></i> -->{l s='Continue shopping' mod='blockcart'}
						</span>
					</span>
					<a class="btn btn-default btn-add"	href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart'}" rel="nofollow">
						<span>
							{l s='Proceed to checkout' mod='blockcart'}<!-- <i class="icon-chevron-right right"></i> -->
						</span>
					</a>
				</div>
		<div class="crossseling clear"></div>
	</div> <!-- #layer_cart -->
