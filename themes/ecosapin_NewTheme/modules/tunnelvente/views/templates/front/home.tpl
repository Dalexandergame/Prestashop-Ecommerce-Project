<div class="btns container">
    <a href="{$base_dir_ssl}module/tunnelvente/type" class="choix_spain_tunn"> {l s="Choisir mon sapin" mod='tunnelvente'}</a>
...
<div id="my_littel_ecosapin">
    <div class="container">
        ...
        <a href="{$base_dir_ssl}stock-pack/93-my-little-ecosapin.html" class="little_ecosapin" title="{l s="Choisir mon little ecosapin " mod='tunnelvente'}">{l s="Choisir mon little ecosapin " mod='tunnelvente'} </a>
    </div>
</div>
