{if isset($autresapin) && $autresapin}
    ...
    $(function($){   
        try{
            $.ajax({
            type: 'GET',
                url: "{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/type",
...
{else}
    <form action="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/commande" id="form_accessoire"
          method="post">
