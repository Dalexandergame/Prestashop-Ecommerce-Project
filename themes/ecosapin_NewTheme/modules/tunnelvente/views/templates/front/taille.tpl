<form action="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/sapin" id="form_taille"
      method="post">
   <h4>{l s="Choose fir size" mod='tunnelvente'}</h4>
   <ul>
   {foreach from=$tailles item=taille}
       <li data-id="{$taille.id}"
           data-src="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}modules/tunnelvente/images/tailles/{$taille.name|replace:" ":"_"|replace:"/":"x"}{if !$taille.enpot}-coupe{/if}.png">
...
<script type="text/javascript">
    ...
    var baseurl = "{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}img/cms/tunnel_tailles/";
