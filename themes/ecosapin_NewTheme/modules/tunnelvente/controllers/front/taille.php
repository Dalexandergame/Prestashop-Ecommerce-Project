...
class tunnelventetailleModuleFrontController extends tunnelventelittleModuleFrontController {
    ...
    private function getHtmlTaille($type) {
        ...
        $smarty->assign(array(
            ...
            "id_attribute_taille"=> ($this->getValueTunnelVent("id_attribute_taille")/*$this->context->cookie->id_attribute_taille*/)?$this->getValueTunnelVent("id_attribute_taille")/*$this->context->cookie->id_attribute_taille*/:'',
            "typetpl" => $typetpl
        ));
