...
{else}
	<h1 class="page-heading step-num"><b><span>03 /</span> {l s='Please choose your payment method'}</b></h1>
{/if}
		...
		<div class="paiement_block">
			<div id="HOOK_TOP_PAYMENT">{$HOOK_TOP_PAYMENT}</div>
				{if $HOOK_PAYMENT}
					...
					<div class="order-payment-no-convienne">
						{if strpos($HOOK_PAYMENT, 'class="warning"') === false}
							{l s='Si ces moyens de paiements ne vous conviennent pas'},
							<a href="mailto:contact@ecosapin.ch">contactez-nous</a>
							{l s='au +41 21 539 11 16'}
						{/if}
					</div>
...
{* Pour le css de la bannière cherry checkout *}                       
<script type="text/javascript">
$("#cherrycheckout_block .col-sm-7 div.row:eq( 2 ) .col-sm-2").removeClass("col-sm-2").addClass("col-sm-4");
$("#cherrycheckout_block .col-sm-7 div.row:eq( 2 ) .col-sm-10").removeClass("col-sm-10").addClass("col-sm-8");
</script>
                        <script type="text/javascript">
                            $(function($){
                                $('textarea#message').blur(function(){
                                    ...
                                    if( comment == ''){                                       
                                        ...
                                        $('textarea#message').css('border','2px solid #a3c272');
                                    }
                                });
                            });
                        </script>