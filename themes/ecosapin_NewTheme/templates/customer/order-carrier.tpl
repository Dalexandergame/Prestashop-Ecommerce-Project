...
<h1 class="page-heading step-num"><b><span>02 /</span> {l s='Delivery methods'}</b></h1>
...
{else}
<div class="delivery_options_address row">
{if isset($delivery_option_list)}
    {foreach $delivery_option_list as $id_address => $option_list}
        <p class="carrier_title col-md-12">
        ...
        <div class="delivery_options col-md-12">
            {foreach $option_list as $key => $option}
                <div class="delivery_option {if ($option@index % 2)}alternate_{/if}item">
                    <div>
                        <table class="resume table{if !$option.unique_carrier} hide{/if}">
                            <tr>
...
{if $opc}
    <p class="carrier_title norm">{l s='Leave a message'}</p>
    <div>
        <p class="text_carrier">{l s='If you would like to add a comment about your order, please write it in the field below.'}</p>
                                <p id="message-error" class="warning" style="display:none;">{l s='Command message is required.'}</p>
        <textarea class="form-control" cols="120" rows="4" name="message" id="message">{strip}
...
{/if}
<div class="">
    <p class="carrier_title norm">{l s='Terms of service'}</p>
    <div class="row">
    <p class="checkbox col-md-12" style="margin-top:15px">
