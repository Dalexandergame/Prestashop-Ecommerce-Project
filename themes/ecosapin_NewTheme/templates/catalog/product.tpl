...
{if $errors|@count == 0}
	...
	{/if}
{*{assign var='myLittelEcosapin' value=true}*}
<div itemscope itemtype="http://schema.org/Product">
	<div class="primary_block row">
		...
		{/if}
		<!-- left infos-->
		<div class="pb-left-column {if !$myLittelEcosapin}col-xs-12 col-sm-4 col-md-5{/if}">
			...
			<div id="image-block" class="clearfix">
				...
				{/if}
                                {if $myLittelEcosapin} {* afficher le prix ici*}
				...
				{if $have_image}
					<span id="view_full_size">
						...
						{else}
							...
							{if !$content_only && !$myLittelEcosapin}
			...
			{if isset($images) && count($images) > 0}
				<!-- thumbnails -->
				<div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if} {if $myLittelEcosapin} hidden{/if}">
			...
			{if isset($images) && count($images) > 1}
				<p class="resetimg clear no-print {if $myLittelEcosapin}hidden {/if}">
		...
		<!-- end left infos-->
		<!-- center infos -->
		<div class="pb-center-column {if !$myLittelEcosapin}col-xs-12 col-sm-4{/if}">
                    {if !$myLittelEcosapin}
			...
			{if $PS_STOCK_MANAGEMENT}
				...
				<p class="warning_inline" {if ($product->quantity > $last_qties || $product->quantity <= 0) || $allow_oosp || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none"{/if} ><span id="last_quantities">{l s='Warning: Last items in stock!'}</span></p>
			{/if}
			...
			{if isset($HOOK_EXTRA_RIGHT) && $HOOK_EXTRA_RIGHT && !$myLittelEcosapin}{$HOOK_EXTRA_RIGHT}{/if}
			{if !$content_only && !$myLittelEcosapin }
				<!-- usefull links-->
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
		...
		{/if}
            <div class="mytabs">
                <div class=" container">
                    {if (isset($features) && $features) || $product->description}
                        <ul id="infostabs">
                            {if $product->description }
                            <li><a href="#mydescription">{l s='More info'}</a></li>
                            {/if}
                            {if isset($features) && $features}
                            <li><a href="#myfeatures">{l s='Data sheet'}</a></li>
                            {/if}

                            {if isset($attachments) && $attachments}
                            <li><a href="#mydownload">{l s='Download'}</a></li>
                            {/if}
		...
		{if isset($features) && $features}
			<!-- Data sheet -->
			<section class="page-product-box" id="myfeatures">				
		...
		{if $product->description}
			<!-- More info -->
			<section class="page-product-box" id="mydescription">				
					<!-- full description -->
		...
		{/if}
		{if isset($packItems) && $packItems|@count > 0}
		<section class="page-product-box" id="blockpack">
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			{if isset($attachments) && $attachments}
			<!--Download -->
			<section class="page-product-box"  id="mydownload">
				{foreach from=$attachments item=attachment name=attachements}
					{if $smarty.foreach.attachements.iteration %3 == 1}<div class="row">{/if}
						<div class="col-md-12" id="donwload-wrapper">
...
<!-- a supprimer -->
<style>.pb-left-column #image-block {
