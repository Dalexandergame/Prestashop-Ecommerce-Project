 ...
 */
class AdminStockManagementOldControllerCore extends AdminController
{
    ...
    public function init()
    {
        ...
        if (!empty($product_name)) {
            $this->toolbar_title = is_array($this->toolbar_title) ? reset($this->toolbar_title) : $this->toolbar_title;
