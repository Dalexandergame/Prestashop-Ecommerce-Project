...
//    use Functions;
    ...
    public function requete($npa)
    {
        ...
        $this->id_attributeRemoved = [];                                                        // les sapins de taille 220/250 et 270/300 ne doivent pas être disponible si c’est une livraison par la poste.
