    ...
    <div class="row options-step">
        <div class="col-md-3">
            <div data-id="0" data-price="0.00"
                 data-name="{if $lang_iso == 'fr' }Sans Pied{elseif $lang_iso == 'en'}No Base{elseif $lang_iso == 'de'}Ohne Ständer{/if}"
                 class="option-attribute-container">
                <div class="attribute-img-container"
                     style="background:url({$img_dir}Tronc-simple1.jpg); background-position: center;background-size: 100% 350px;background-repeat: no-repeat;">
        ...
        {foreach from=$result item=pied}
            <div class="col-md-3">
                <div data-id="{$pied.id_product_attribute}" data-price="{$pied.price_ttc}" data-name="{$pied.name}"
                     class="option-attribute-container">
                    <div class="attribute-img-container"
