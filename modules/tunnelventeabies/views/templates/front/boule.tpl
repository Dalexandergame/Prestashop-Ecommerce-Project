<form action="{$urls.base_url}module/tunnelventeabies/pot" id="form_boule" method="post">
    <h4>{l s="Choisissez le type de décoration" mod='tunnelventeabies'}</h4>
        ...
        <div class="list_boule">
            {foreach from=$result item=boule}
                ...
                <input style="display: none;" type="radio" name="boule" class="radio_boule" value="0" checked
                       data-price="0"/>
                {l s="Aucune décoration disponible"  mod='tunnelventeabies'}
            </span>
                <img class="eco_img" style="display: none;"
                     src="{$urls.base_url}modules/tunnelventeabies/views/img/bg-default-white.png"/>
            {/foreach}
        </div>
        {if count($result)}
            <ul>
                <li data-id="0">
                    ...
                    <label for="boule_0">{l s="Non merci j'ai mes propres boule" mod='tunnelventeabies'}</label>
                    <img class="eco_img" style="display: none;"
                         src="{$urls.base_url}modules/tunnelventeabies/views/img/bg-default-white.png"/>
                </li>
            </ul>
    ...
    <div class="icon-tunnel">
        ...
        {*<h2>{l s="Choisissez le type de décoration" mod='tunnelventeabies'}</h2>*}
    </div>
    <div class="clear"></div>
...
<script type="text/javascript">
    var baseurl_tunnelvente = "{$urls.base_url}module/tunnelventeabies/recyclage?back=1";
</script>
