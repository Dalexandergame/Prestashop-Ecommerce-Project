...
<form action="{$urls.base_url}module/tunnelventeabies/autresapin" id="form_little" method="post">
...
<div class="icon-tunnel">
        ...
        {*<h2>{l s="Choisissez les accessoires de votre little ecosapin" mod='tunnelventeabies'}</h2>*}
   </div> 
<div class="clear"></div>
