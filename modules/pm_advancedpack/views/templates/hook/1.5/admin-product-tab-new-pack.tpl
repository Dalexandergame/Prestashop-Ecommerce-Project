<div id="product-new-pack" class="panel product-tab ps-15">
...
<script>
	...
	ap5_deleteConfirmationMessage = "{l s='Do you really want to delete this product from the pack?' mod='pm_advancedpack'}";
	ap5_packIdTaxRulesGroup = {Tools::jsonEncode($idTaxRulesGroup)};
	ap5_warehouseMessage = "{l s='You can\'t have different warehouse into the pack, please choose another product in order to continue.' mod='pm_advancedpack'}";
	ap5_packIdWarehouse = {Tools::jsonEncode($idWarehouse)};
	ap5_displayMode = {Tools::jsonEncode($packDisplayMode)};
	ap5_atLeastOneCombinationMessage = "{l s='You must have at least one selected combination.' mod='pm_advancedpack'}";
	ap5_atLeastTwoProductMessage = "{l s='Do you really want to create a pack with only one product inside ?' mod='pm_advancedpack'}";
	ap5_atLeastOneProductMessage = "{l s='You must have at least one product into the pack.' mod='pm_advancedpack'}";
	if (typeof(ap5_initNewPackFields) != 'undefined') {
		ap5_setProductTabName('{l s='Pack configuration' mod='pm_advancedpack'}');
