<form action="{$base_url}/module/tunnelvente/accesoire" id="form_autresapin" method="post">
    <h4>{l s="Nouveau sapin" mod='tunnelvente'}</h4> 
    <ul>
         <li data-id="0" data-src="{$base_url}/modules/tunnelvente/images/resume.png">
        ...
        <li data-id="1" data-src="{$base_url}/modules/tunnelvente/images/eco_new.png" >
        ...
        <li data-id="2" data-src="{$base_url}/modules/tunnelvente/images/icon_little.png">
...
<script type="text/javascript">
    {if $little}
        var baseurl_tunnelvente = "{$base_url}/module/tunnelvente/little";
    {else}
        var baseurl_tunnelvente = "{$base_url}/module/tunnelvente/pot";
    {/if}
</script> 
{literal}
<script type="text/javascript">
