<form action="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}module/tunnelvente/taille" id="form_type" method="post">
...
<script type="text/javascript">
    ...
    $('.container_type .transporteur img').attr('src',"{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}modules/ecosapinpartners/uploads/"+partner_img );
