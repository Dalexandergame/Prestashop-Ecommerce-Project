...
//                var_dump($this->_list);exit;
		...
		$list = str_replace('index.php?controller=AdminPlanningDeliveryByCarrierController&amp;id_order=',
		'index.php?controller=adminorders&amp;id_order=', $list);
	...
	/*public function l($string, $classes = 'AdminTab', $addslashes = false, $htmlentities = true)
	{
		$classes = 'AdminPlanningDeliveryByCarrierController';
		$planning_delivery = New PlanningDeliveryByCarrier();
		return $planning_delivery->l($string, $classes, $addslashes, $htmlentities);
	}*/
