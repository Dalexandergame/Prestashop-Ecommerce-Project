<div class="order_carrier_content twintcw-external-checkout-carrier-box box">
	...
	{if isset($virtual_cart) && $virtual_cart}
		<p>{lcw s='No shipping method needed.' mod='twintcw'}</p>
...
<p class="cart_navigation clearfix">
	{if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
		<button type="submit" name="processCarrier" id="shipping-method-submit-button" class="button btn btn-default standard-checkout button-medium">
			<span>
				{lcw s='Save Shipping Method' mod='twintcw'}
...
<!-- 
var twintcwJqueryLoaded = function() {
    jQuery('#shipping-method-submit-button').hide();
    jQuery('.twintcw-external-checkout-carrier-box').each(function() {
            var box = $(this);
...
if (document.readyState == "complete") { twintcwJqueryLoaded(); }
else if (window.addEventListener) { window.addEventListener("load", twintcwJqueryLoaded, false); }
else if (window.attachEvent) { window.attachEvent("onload", twintcwJqueryLoaded); }
else { window.onload = twintcwJqueryLoaded; }
-->
</script>
{/literal}