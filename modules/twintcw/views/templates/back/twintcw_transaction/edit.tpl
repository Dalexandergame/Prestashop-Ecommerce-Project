		...
		<div class="pageTitle">
			<h3>
				<span id="current_obj" style="font-weight: normal;"> 
					...
					<span class="breadcrumb item-2 ">{lcw s='View' mod='twintcw'}</span>
				</span>
			</h3>
		</div>
	</div>
...
<table class="table table-striped table-condensed table-hover table-bordered">
	...
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Transaction ID'}</th>
		<td>{$transaction->getTransactionId()}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Transaction Number'}</th>
		<td>{$transaction->getTransactionExternalId()}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Authorization Status'}</th>
		<td>{$transaction->getAuthorizationStatus()}</td>
	</tr>
	{if !empty({$transaction->getOrderId()})}
		<tr>
			<th class="col-lg-3">{lcw  mod='twintcw' s='Order ID'}</th>
			<td>{$transaction->getOrderId()}
				<a href="{$link->getAdminLink('AdminOrders')|escape:'htmlall':'UTF-8'}&id_order={$transaction->getOrderId()}&vieworder" class="button">{lcw s='View' mod='twintcw'}</a>
			
			</td>
		</tr>
	{/if}
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Created On'}</th>
		<td>{$transaction->getCreatedOn()->format("Y-m-d H:i:s")}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Updated On'}</th>
		<td>{$transaction->getUpdatedOn()->format("Y-m-d H:i:s")}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Customer ID'}</th>
		<td>{$transaction->getCustomerId()}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Payment ID'}</th>
	...
	{if is_object($transaction->getTransactionObject()) && $transaction->getTransactionObject()->isAuthorized() && $transaction->getTransactionObject()->getPaymentInformation() != null}
		<tr>
			<th class="col-lg-3">{lcw  mod='twintcw' s='Payment Information'}</th>
...
<h3>{lcw  mod='twintcw' s='Captures for this transaction'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	<thead>
		<tr>
			<th>{lcw  mod='twintcw' s='Date'}</th>
			<th>{lcw  mod='twintcw' s='Amount'}</th>
			<th>{lcw  mod='twintcw' s='Status'}</th>
			<th> </th>
		</tr>
	</thead>
	<tbody>
...
<h3>{lcw  mod='twintcw' s='Refunds for this transaction'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	<thead>
		<tr>
			<th>{lcw  mod='twintcw' s='Date'}</th>
...
<h3>{lcw  mod='twintcw' s='Transactions History'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	<thead>
		<tr>
			<th>{lcw  mod='twintcw' s='Date'}</th>
			<th>{lcw  mod='twintcw' s='Action'}</th>
			<th>{lcw  mod='twintcw' s='Message'}</th>
		</tr>
	</thead>
	<tbody>
...
{if is_object($transactionObject)}
<h3>{lcw  mod='twintcw' s='Customer Data'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	...
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Billing Address'}</th>
		<td>
			...
			{if $context->getBillingDateOfBirth() !== null}
				{lcw  mod='twintcw' s='Birthday'}: {$context->getBillingDateOfBirth()->format("Y-m-d")}<br />
			{/if}
			{if $context->getBillingPhoneNumber() !== null}
				{lcw  mod='twintcw' s='Phone'}: {$context->getBillingPhoneNumber()|escape:'htmlall'}<br />
			{/if}
		</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='twintcw' s='Shipping Address'}</th>
		<td>
			...
			{if $context->getShippingDateOfBirth() !== null}
				{lcw  mod='twintcw' s='Birthday'}: {$context->getShippingDateOfBirth()->format("Y-m-d")}<br />
			{/if}
			{if $context->getShippingPhoneNumber() !== null}
				{lcw  mod='twintcw' s='Phone'}: {$context->getShippingPhoneNumber()|escape:'htmlall'}<br />
			{/if}
		</td>
	</tr>
</table>
<br />
<h3>{lcw  mod='twintcw' s='Products'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	<thead>
		<tr>
			<th>{lcw  mod='twintcw' s='Name'}</th>
			<th>{lcw  mod='twintcw' s='SKU'}</th>
			<th>{lcw  mod='twintcw' s='Quantity'}</th>
			<th>{lcw  mod='twintcw' s='Type'}</th>
			<th>{lcw  mod='twintcw' s='Tax Rate'}</th>
			<th>{lcw  mod='twintcw' s='Amount (excl. VAT)'}</th>
			<th>{lcw  mod='twintcw' s='Amount (inkl. VAT)'}</th>
		</tr>
	</thead>
	<tbody>
