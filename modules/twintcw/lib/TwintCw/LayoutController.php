 ...
 */
final class TwintCw_LayoutController extends ModuleFrontController {
	...
	public function initContent(){
		...
		$this->addCSS(_MODULE_DIR_ . 'twintcw/css/style.css');
		...
		$this->setTemplate('module:twintcw/views/templates/front/default.tpl');
	}
