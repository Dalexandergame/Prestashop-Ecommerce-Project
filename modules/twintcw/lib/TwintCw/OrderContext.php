...
class TwintCw_OrderContext extends Customweb_Payment_Authorization_OrderContext_AbstractDeprecated implements Customweb_Payment_Authorization_IOrderContext
{
	private $cartId;
	private $customerId;
	private $carrierName;
	...
	public function __construct($cart, Customweb_Payment_Authorization_IPaymentMethod $paymentMethod) {
		...
		$key = TwintCw_Util::getCheckoutCookieKey($paymentMethod);
		...
		$this->employeeId = TwintCw_Util::getEmployeeIdFromCookie();
	}
	...
	private function buildLineItems(Cart $cart, $orderTotal) {
		return TwintCw_Util::createLineItemsFromCart($cart, $orderTotal, $this->getPaymentMethod());
	}
