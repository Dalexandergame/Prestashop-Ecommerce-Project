...
class TwintCw_Migration_1_0_0 implements Customweb_Database_Migration_IScript{
	
	public function execute(Customweb_Database_IDriver $driver) {
		
		$driver->query("CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "twintcw_customer_contexts` (
		...
		$driver->query("CREATE TABLE IF NOT EXISTS `twintcw_storage` (
		...
		$driver->query("CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "twintcw_transactions` (
