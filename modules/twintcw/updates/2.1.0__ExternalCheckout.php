...
class TwintCw_Migration_2_1_0 implements Customweb_Database_Migration_IScript{

	public function execute(Customweb_Database_IDriver $driver) {

		$driver->query("CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "twintcw_external_checkout_contexts (
