...
class TwintCwServerModuleFrontController extends ModuleFrontController {
	public $ssl = true;
...
require_once 'TwintCw/Entity/Transaction.php';
		...
		$adapter = TwintCw_Util::getAuthorizationAdapter($transaction->getAuthorizationType());
		...
		TwintCw_Util::getTransactionHandler()->persistTransactionObject($transactionObject);
