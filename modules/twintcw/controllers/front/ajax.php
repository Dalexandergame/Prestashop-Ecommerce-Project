...
class TwintCwAjaxModuleFrontController extends ModuleFrontController {
	public $ssl = true;
...
require_once 'TwintCw/Entity/Transaction.php';
		...
		$adapter = TwintCw_Util::getShopAdapterByPaymentAdapter(TwintCw_Util::getAuthorizationAdapterByContext($orderContext));
