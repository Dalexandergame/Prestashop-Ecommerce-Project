 ...
 *
 */
class TwintCwBreakOutModuleFrontController extends ModuleFrontController {
	public $ssl = true;
...
require_once 'TwintCw/Entity/Transaction.php';
		...
		TwintCw_Util::redirectSetCookieIfRequired('breakout');
		...
		$dbTransaction = TwintCw_Entity_Transaction::loadById($id_transaction);
		...
		$this->setTemplate('module:twintcw/views/templates/front/breakout.tpl');
	}
}
