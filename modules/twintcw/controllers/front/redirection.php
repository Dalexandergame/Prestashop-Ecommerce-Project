...
class TwintCwRedirectionModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
...
require_once 'TwintCw/Entity/Transaction.php';
		...
		$dbTransaction = TwintCw_Entity_Transaction::loadById(intval($_GET['cw_transaction_id']));
		...
		$authorizationAdapter = TwintCw_Util::getAuthorizationAdapter($dbTransaction->getTransactionObject()->getAuthorizationMethod());
