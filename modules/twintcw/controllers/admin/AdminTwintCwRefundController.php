 ...
 *      	   	 	  			 	  
 */
class AdminTwintCwRefundController extends AdminController
{
	public function __construct() {
		$this->className = 'AdminTwintCwRefundController';
		parent::__construct();
		$this->context->smarty->addTemplateDir($this->getTemplatePath());
		$this->tpl_folder = 'twintcw_refund/';
		$this->bootstrap = true;
	}
	...
	public function initContent()
	{
		...
		$data = $_GET;
		$transaction = current(TwintCw_Entity_Transaction::getTransactionsByOrderId((int)$data['id_order']));
		...
		$vars['refundAmount'] = TwintCw::getRefundAmount($data);
